...
class ResultScreen(private val mGame: JumpActionGame, private val mScore: Int) : ScreenAdapter() {
    ...
    init {
        ...
        //  追加　AdMob関連
        // ResultScreenが表示された時　=　初期表示のこと
        // ActivityRequestHandlerのshowAdsMethodにtrusを与えて使用
        // AdMobを　表示　　
        if (mGame.mRequestHandler != null) { // 追加
            mGame.mRequestHandler.showAds(true) //追加
        } //追加
    ...
    override fun render(delta: Float) {
        ...
        if (Gdx.input.justTouched()) {
            ...
            //  追加　AdMob関連
            // GameScreenに戻るとき
            // ActivityRequestHandlerのshowAdsMethodにfalseを与えて呼び出してAdMobを非表示　　
            if (mGame.mRequestHandler != null) { //追加
                mGame.mRequestHandler.showAds(false) //追加
            } //追加
...
//空のままだったupdateGameOver Methodの中身を記述